...
int main(int argc, char * argv[]) {
    ...
    std::string dfile = workingdir + "DWSOL.lis";
    ...
    TString savefile = workingdir + "output/results.root";
    ...
    TString filename = workingdir + "/output/timeEl.root";
    ...
    filename = workingdir + "/output/timeIon.root";
